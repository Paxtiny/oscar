...
var (
	...
	ErrAnonymousRecognitionRateLimited      = NewNormalError(NormalSubcategoryLargeLanguageModel, 5, http.StatusTooManyRequests, "too many anonymous recognition requests")
	ErrAnonymousRecognitionNotEnabled       = NewNormalError(NormalSubcategoryLargeLanguageModel, 6, http.StatusBadRequest, "anonymous receipt recognition is not enabled")
)
